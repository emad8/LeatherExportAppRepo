<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formCuttingIssuance.aspx.cs" Inherits="LeatherExportApp.forms.formCuttingIssuance" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Form Cutting Issuance</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
