$(document).ready(function () {
    ...
    oTable = $('#example').DataTable({
        ...
        bServerSide: true,
        sAjaxSource: '../WebServices/ServiceCuttingOutStock.asmx/FilterGet',
        sServerMethod: 'post',
    ...
    $('.showHide').on('click', function () {
        var col = oTable.column($(this).attr('data-column-index'));
...
function Delete(Id) {
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/ServiceCuttingOutStock.asmx/Delete",
...
function Update() {
    ...
    $.ajax({
        method: "post",
        //getListOfCars is my webmethod
        url: "../WebServices/ServiceCuttingOutStock.asmx/Update",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        success: function (result) {
...
function SetInfo() {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceCuttingOutStock.asmx/Get",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        dataType: "json", // dataType is json format
        success: function (result) {
            
            document.getElementById(ddlCompany).value = result.d.Company;
...
function onchangeLot1() {
    ...
    if (document.getElementById(ddlLot1).value != "")
    {
        ...
        $.ajax({
            method: "post",
            url: "../WebServices/ServiceCuttingOutStock.asmx/GetLot_PcsSqft",
            data: JSON.stringify(Info),
            contentType: "application/json; charset=utf-8",
            dataType: "json", // dataType is json format
            success: function (result) {
...
function Fill_Lot1() {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceCuttingOutStock.asmx/GetLot1",
        //data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        dataType: "json", // dataType is json format
...
function Fill_Lot1All() {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceCuttingOutStock.asmx/GetLotAll",
        //data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        dataType: "json", // dataType is json format
        success: function (response) {
...
function Fill_Lot2() {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceCuttingOutStock.asmx/GetLot2",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        dataType: "json", // dataType is json format
        success: function (response) {
...
function Validate() {
    ...
    if (document.getElementById(ddlCompany).value == "") {
        document.getElementById(lblMessage).innerHTML += "Please select Company<br>";
    }
    if (document.getElementById(ddlLot1).value == "") {
