...
$(document).ready(function () {
    //$.ajax({
        //url: '../WebServices/ServiceCompany.asmx/getListOfCompanys',
        //method: 'post',
        //dataType: 'json',
        //success: function (data) {
            oTable= $('#example').dataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        'render': function (oObj) {
                            ...
                            return '<td><a href=\'javascript:;\' onclick="return Get_Company_By_Id(' + oObj + ')" data-toggle="modal" data-target="#myModal" > <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  </a></td>';
                        }
                    },
                    {
                        'data': 'ForDelete',
                ...
                bServerSide: true,
                sAjaxSource: '../WebServices/ServiceCompany.asmx/Filter_Get_Company',
                sServerMethod: 'post',
...
function Delete(Id) {
    ...
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/ServiceCompany.asmx/DeleteCompanyById",
...
function Get_Company_By_Id(Id) {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceCompany.asmx/Get_Company_By_Id",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
...
function Update() {
    ...
    $.ajax({
        method: "post",
        //getListOfCars is my webmethod
        url: "../WebServices/ServiceCompany.asmx/Update",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            if (result.d == "1") {
