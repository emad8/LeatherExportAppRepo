<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="LeatherApp.edit.test" %>
                    ...
                    <tr>
                        <td style="width:50%" valign="top" align="center">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
                                SelectCommand="SELECT Id, Name, Description, IsDeleted FROM Style WHERE (UPPER(Name) = UPPER(@NAME))" >
                                <SelectParameters>
