...
$(document).ready(function () {
    //$.ajax({
        //url: '../WebServices/ServiceMarket.asmx/getListOfMarkets',
        //method: 'post',
        //dataType: 'json',
        //success: function (data) {
            oTable= $('#example').dataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        'render': function (oObj) {
                            ...
                            return '<td><a href=\'javascript:;\' onclick="return Get_Market_By_Id(' + oObj + ')" data-toggle="modal" data-target="#myModal" > <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  </a></td>';
                        }
                    },
                    {
                        'data': 'ForDelete',
                ...
                bServerSide: true,
                sAjaxSource: '../WebServices/ServiceMarket.asmx/Filter_Get_Market',
                sServerMethod: 'post',
...
function Delete(Id) {
    ...
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/ServiceMarket.asmx/DeleteMarketById",
...
function Get_Market_By_Id(Id) {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceMarket.asmx/Get_Market_By_Id",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
...
function Update() {
    ...
    $.ajax({
        method: "post",
        //getListOfCars is my webmethod
        url: "../WebServices/ServiceMarket.asmx/Update",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            if (result.d == "1") {
