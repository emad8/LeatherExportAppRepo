<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formWadaGhata.aspx.cs" Inherits="LeatherExportApp.edit.formWadaGhata" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Wada Ghata</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="modal-dialog ">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Form Wada Ghata</h4>
                            </div>
    ...
    <script src="../js/MyJs/WadaGhata.js"></script>
    <script>
