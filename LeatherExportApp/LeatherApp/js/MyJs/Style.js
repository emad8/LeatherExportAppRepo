...
$(document).ready(function () {
    ...
    oTable = $('#example').dataTable({
        ...
        bServerSide: true,
        sAjaxSource: '../WebServices/ServiceStyle.asmx/Filter_Get_Style',
        sServerMethod: 'post',
...
function Delete(Id) {
    ...
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/ServiceStyle.asmx/DeleteStyleById",
...
function Get_Style_By_Id(Id) {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceStyle.asmx/Get_Style_By_Id",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
...
function Update() {
    ...
    $.ajax({
        method: "post",
        //getListOfCars is my webmethod
        url: "../WebServices/ServiceStyle.asmx/Update",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            if (result.d == "1") {
