<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formContractor.aspx.cs" Inherits="LeatherExportApp.forms.formContractor" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Form Contractor</h1>
            </div>
            <!-- /.col-lg-12 -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div id="widthOuter" class="form-group input-group">
                                    <span id="widthInner" class="input-group-addon">Contractor <label style="color: red;"> *</label></span>
                                    <asp:TextBox ID="Name" required="required" class="form-control" placeholder="insert Contractor number..."
