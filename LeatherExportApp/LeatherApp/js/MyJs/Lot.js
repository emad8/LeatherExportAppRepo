...
$(document).ready(function () {
    //$.ajax({
        //url: '../WebServices/ServiceLot.asmx/getListOfLots',
        //method: 'post',
        //dataType: 'json',
        //success: function (data) {
            oTable= $('#example').dataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        'render': function (oObj) {
                            ...
                            return '<td><a href=\'javascript:;\' onclick="return Get_Lot_By_Id(' + oObj + ')" data-toggle="modal" data-target="#myModal" > <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  </a></td>';
                        }
                    },
                    {
                        'data': 'ForDelete',
                ...
                bServerSide: true,
                sAjaxSource: '../WebServices/ServiceLot.asmx/Filter_Get_Lot',
                sServerMethod: 'post',
...
function Delete(Id) {
    ...
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/ServiceLot.asmx/DeleteLotById",
...
function Get_Lot_By_Id(Id) {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/ServiceLot.asmx/Get_Lot_By_Id",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
...
function Update() {
    ...
    $.ajax({
        method: "post",
        //getListOfCars is my webmethod
        url: "../WebServices/ServiceLot.asmx/Update",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            if (result.d == "1") {
