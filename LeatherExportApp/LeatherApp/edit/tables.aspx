<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tables.aspx.cs" Inherits="LeatherExportApp.edit.tables" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <button type="button" id="button" onclick="return confirm('Are you sure you want to delete this Record?');" class="btn btn-default" aria-label="Left Align">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                        </button>

                        <span class="btn btn-primary glyphicon glyphicon-trash" aria-hidden="true"></span>
    ...
    <script src="../js/MyJs/Styles.js"></script>
    <script>
