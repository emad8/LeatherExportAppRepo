<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formVendor.aspx.cs" Inherits="LeatherExportApp.edit.formVendor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtName" required="required" class="form-control" placeholder="insert Vendor..."></asp:TextBox>
                                </div>
                                <div class="form-group input-group">
    ...
    <script src="../js/MyJs/Vendor.js"></script>
    <script>
