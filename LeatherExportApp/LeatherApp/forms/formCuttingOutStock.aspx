<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formCuttingOutStock.aspx.cs" Inherits="LeatherExportApp.forms.formCuttingOutStock" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Form CuttingOutStock</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group" runat="server">
                                    ...
                                    <asp:DropDownList ID="ddlCompany" DataTextField="Name" DataValueField="Id" required="required" class="form-control" runat="server"></asp:DropDownList>
                                    <asp:SqlDataSource ID="sqlCompany" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Company.Id,Company.Name FROM [Company] where Company.IsDeleted=0"></asp:SqlDataSource>
                                </div>
