/// <reference path="../../edit/tables.aspx" />
//var oTable;

$(document).ready(function () {
    //$.ajax({
    //url: '../WebServices/Myfunction2.asmx/getListOfStyles',
    //method: 'post',
    //dataType: 'json',
    ...
    oTable = $('#example').dataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                'render': function (oObj) {
                    ...
                    return '<td><a href=\'javascript:;\' onclick="return Get_Style_By_Id(' + oObj + ')" data-toggle="modal" data-target="#myModal" > <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  </a></td>';
                }
            },
            {
                'data': 'ForDelete',
        ...
        bServerSide: true,
        sAjaxSource: '../WebServices/Myfunction2.asmx/Filter_Get_Style',
        sServerMethod: 'post',
...
function Delete(Id) {
    ...
    if (confirm('Are you sure you want to delete this Record?')) {
        ...
        $.ajax({
            ...
            url: "../WebServices/Myfunction2.asmx/DeleteStyleById",
...
function Get_Style_By_Id(Id) {
    ...
    $.ajax({
        method: "post",
        url: "../WebServices/Myfunction2.asmx/Get_Style_By_Id",
        data: JSON.stringify(Info),
        contentType: "application/json; charset=utf-8",
        dataType: "json", // dataType is json format
        success: function (result) {
...
function GetDDl(obj) {
    ...
    if (obj.value != "")
        $.ajax({
            method: "post",
            url: "../WebServices/Myfunction2.asmx/GetDDl",
            data: JSON.stringify(Info),
            contentType: "application/json; charset=utf-8",
            dataType: "json", // dataType is json format
            success: function (response) {
                ...
                document.getElementById(ddlLot2).value = '13';
            },
