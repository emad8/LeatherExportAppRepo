<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formContractor.aspx.cs" Inherits="LeatherExportApp.edit.formContractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="modal-dialog ">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Form Contractor</h4>
                            </div>
                            <div class="modal-body">
                                <asp:Label runat="server" ID="lblMessage"></asp:Label>
                                <div class="form-group input-group">
                                    <span class="input-group-addon">Contractor</span>
                                    <asp:TextBox runat="server" ID="txtName" required="required" class="form-control" placeholder="insert Contractor..."></asp:TextBox>
                                </div>
                                <div class="form-group input-group">
    ...
    <script src="../js/MyJs/Contractor.js"></script>
    <script>
